...
<div class="container py-5">
  <div class="card form-card p-4">
    ...
    <form method="POST" action="{{ route('awkum.update', $studentData->id) }}">
        @csrf
        @method('PUT')
      <div class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" 
                   ...
                   {{ $studentData->adm_status == 'Self' ? 'checked' : '' }}>
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" 
                   ...
                   {{ $studentData->adm_status == 'Open' ? 'checked' : '' }}>
        ...
        <div class="col-md-12">
          ...
          <div class="form-check form-check-inline">
            <input type="checkbox" name="adm_discipline[]" value="Hons"
                   ...
                   {{ in_array('Hons', explode(',', $studentData->adm_discipline)) ? 'checked' : '' }}>
          ...
          <div class="form-check form-check-inline">
            <input type="checkbox" name="adm_discipline[]" value="Software"
                   class="form-check-input"
                   {{ in_array('Software', explode(',', $studentData->adm_discipline)) ? 'checked' : '' }}>
          ...
          <div class="form-check form-check-inline">
            <input type="checkbox" name="adm_discipline[]" value="Cyber"
                   class="form-check-input"
                   {{ in_array('Cyber', explode(',', $studentData->adm_discipline)) ? 'checked' : '' }}>
          ...
          <div class="form-check form-check-inline">
            <input type="checkbox" name="adm_discipline[]" value="AI"
                   class="form-check-input"
                   {{ in_array('AI', explode(',', $studentData->adm_discipline)) ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
          ...
          <select name="adm_campus" 
            ...
            <option value="Garden"  {{ $studentData->adm_campus == 'Garden' ? 'selected' : '' }}>Garden</option>
            <option value="Main"    {{ $studentData->adm_campus == 'Main' ? 'selected' : '' }}>Main</option>
            <option value="Shanker" {{ $studentData->adm_campus == 'Shanker' ? 'selected' : ''}}>Shanker</option>
            <option value="Pabbi"   {{ $studentData->adm_campus == 'Pabbi' ? 'selected' : '' }}>Pabbi</option>
      ...
      <div class="text-center mt-4">
        <input type="submit" class="btn btn-primary px-4 py-2" value="Update">
        <a href="{{ route('awkum.index')}}" ><button class="btn btn-primary px-4 py-2">Back</button></a>
      </div>
